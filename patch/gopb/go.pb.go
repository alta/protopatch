...
type Options struct {
	...
	// The prefix option overrides the default prefix for generated name, where applicable.
	// Set to to the empty string ("") to disable the prefix entirely.
	// For enum values, this replaces the default parent enum type prefix.
...
var file_patch_go_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		Field:         7020,
		Name:          "go.initialisms",
		Tag:           "bytes,7020,rep,name=initialisms",
		Filename:      "patch/go.proto",
	},
}
...
var (
	// Set lint to true if generated Go symbols should be linted.
	// Can be overridden by options on a specific message or enum.
	//
	// optional bool lint = 7010;
	...
	//
	// repeated string initialisms = 7020;
	E_Initialisms = &file_patch_go_proto_extTypes[6]
)
...
var file_patch_go_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x31, 0x0a, 0x04, 0x6c, 0x69, 0x6e, 0x74, 0x12, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x6c, 0x65,
	0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0xe2, 0x36, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04,
	0x6c, 0x69, 0x6e, 0x74, 0x3a, 0x3f, 0x0a, 0x0b, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69,
	...
	0x73, 0x18, 0xec, 0x36, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61,
...
var file_patch_go_proto_depIdxs = []int32{
	...
	6,  // 5: go.lint:extendee -> google.protobuf.FileOptions
	6,  // 6: go.initialisms:extendee -> google.protobuf.FileOptions
