...
type CustomStringer int32

const (
	CustomStringer_INVALID CustomStringer = 0
	CustomStringer_A       CustomStringer = 1
	CustomStringer_B       CustomStringer = 2
	CustomStringer_C       CustomStringer = 3
)

// Enum value maps for CustomStringer.
var (
	CustomStringer_name = map[int32]string{
		0: "INVALID",
		1: "A",
		2: "B",
		3: "C",
	}
	CustomStringer_value = map[string]int32{
		"INVALID": 0,
		"A":       1,
		"B":       2,
		"C":       3,
...
func (x CustomStringer) Enum() *CustomStringer {
	p := new(CustomStringer)
	*p = x
	return p
}

func (x CustomStringer) OrigString() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CustomStringer) Descriptor() protoreflect.EnumDescriptor {
	return file_tests_enum_enum_stringer_proto_enumTypes[0].Descriptor()
}

func (CustomStringer) Type() protoreflect.EnumType {
	return &file_tests_enum_enum_stringer_proto_enumTypes[0]
}

func (x CustomStringer) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CustomStringer.Descriptor instead.
func (CustomStringer) EnumDescriptor() ([]byte, []int) {
...
var file_tests_enum_enum_stringer_proto_rawDesc = []byte{
	...
	0x12, 0x0a, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x1a, 0x13, 0x70, 0x61,
	0x74, 0x63, 0x68, 0x2f, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2a, 0x44, 0x0a, 0x0e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x53, 0x74, 0x72, 0x69, 0x6e,
	0x67, 0x65, 0x72, 0x12, 0x0b, 0x0a, 0x07, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x00,
	0x12, 0x05, 0x0a, 0x01, 0x41, 0x10, 0x01, 0x12, 0x05, 0x0a, 0x01, 0x42, 0x10, 0x02, 0x12, 0x05,
	0x0a, 0x01, 0x43, 0x10, 0x03, 0x1a, 0x10, 0xca, 0xb5, 0x03, 0x0c, 0x52, 0x0a, 0x4f, 0x72, 0x69,
	0x67, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_tests_enum_enum_stringer_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_tests_enum_enum_stringer_proto_goTypes = []interface{}{
	(CustomStringer)(0), // 0: tests.enum.CustomStringer
}
